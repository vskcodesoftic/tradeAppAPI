...
const get_iac_org_settings_1 = require("./commands/test/iac-local-execution/org-settings/get-iac-org-settings");
...
async function main() {
    ...
    try {
        ...
        if (globalArgs.options['iac'] &&
            ...
            const experimentalFlowEnabled = await feature_flags_1.isFeatureFlagSupportedForOrg(camelCase('experimental-local-exec-iac'), iacOrgSettings.meta.org);
